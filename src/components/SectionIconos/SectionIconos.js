...
import sectionIconos from "./sectionIconos.css";
    ...
    <div class="container">
      ...
      <div class="icono-p">
        <img
          ...
          height={80}
        />
        <p class="p">Internet por fibra óptica</p>
        </div>
        <div class="icono-p">
        <img
          class="iconoCard"
